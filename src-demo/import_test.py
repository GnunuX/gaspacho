...
defaultgroup.set_user(student)
defaultgroup.set_user(teacher)
defaultgroup.set_manager(paul)
defaultgroup.set_computer(allcomputers)

room = add_group(name=u'room', parent=defaultgroup)
room.set_user(student)
room.set_user(teacher)
room.set_computer(roomcomputers)

mathroom = add_group(name=u'mathroom', parent=room)
mathroom.set_user(student)
mathroom.set_user(teacher)
mathroom.set_manager(fred)
mathroom.set_computer(mathcomputers)

techroom = add_group(name=u'techroom', parent=room)
techroom.set_user(student)
techroom.set_user(teacher)
techroom.set_computer(techcomputers)
